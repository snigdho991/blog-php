    ...
    <div class="box round first grid">
        ...
        <?php
        	if(isset($_GET['deluser'])){
        		...
        		if($deldata == true){
	               echo "<span class='errad'>User Deleted Successfully !</span>"; 
	            } else {
	               echo "<span class='errad'>User Isn't Deleted. Try Again !</span>";
	            }
        	}
        ?>
        ...
        <div class="block">        
			...
			?>
				<tr class="odd gradeX">
					...
					<td><?php echo $fm->textShorten($result['details'], 35); ?></td>
					<td><?php
							if ($result['role'] == '0'){
								echo "<b>Admin</b>";
			...
			?>
					 || <a onclick="return confirm('Are You Sure To Edit ?'); " href="profile.php">Edit</a>
			<?php } ?>
